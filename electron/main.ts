...
function initDatabase(): void {
  ...
  db.exec(`CREATE TABLE IF NOT EXISTS apariencia_almacen (id INTEGER PRIMARY KEY AUTOINCREMENT,uid TEXT DEFAULT '',color_primario TEXT DEFAULT 'blue',tono_primario TEXT DEFAULT '500',fondo_barra TEXT DEFAULT 'white',tono_barra TEXT DEFAULT '500',color_texto_barra TEXT DEFAULT 'auto',tema_visual TEXT DEFAULT 'standard',almacen_id INTEGER DEFAULT 0,almacen_uid TEXT DEFAULT '',created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)`)
  try { db.exec(`ALTER TABLE apariencia_almacen ADD COLUMN color_texto_barra TEXT DEFAULT 'auto'`) } catch {}
  try { db.exec(`ALTER TABLE apariencia_almacen ADD COLUMN tema_visual TEXT DEFAULT 'standard'`) } catch {}
