...
[![Versión](https://img.shields.io/badge/versión-2.13.10-2563eb)](https://github.com/tmpos/tmpos-online/releases/tag/v2.13.10)
[![Descargas](https://img.shields.io/github/downloads/tmpos/tmpos-online/v2.13.10/total)](https://github.com/tmpos/tmpos-online/releases/tag/v2.13.10)
...
[![Descargar TMPOS v2.13.10](https://img.shields.io/badge/Descargar_TMPOS-v2.13.10-16a34a?style=for-the-badge&logo=windows)](https://github.com/tmpos/tmpos-online/releases/download/v2.13.10/TMPOS.Setup.2.13.10.exe)
...
1. Descarga `TMPOS.Setup.2.13.10.exe`.
...
Consulta todos los archivos y notas en la página del [release v2.13.10](https://github.com/tmpos/tmpos-online/releases/tag/v2.13.10).
